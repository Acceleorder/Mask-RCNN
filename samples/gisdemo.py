...
GIS_MODEL_PATH = os.path.join('/home/Mask_RCNN_1/samples/semantic/', "mask_rcnn_semantic_0003.h5")
# Download COCO trained weights from Releases if needed
# if not os.path.exists(GIS_MODEL_PATH):
#     utils.download_trained_weights(GIS_MODEL_PATH)

# Directory of images to run detection on
IMAGE_DIR = os.path.join(ROOT_DIR, "test_s_1")
...
class_names = ['fault','boudimage','fold']
